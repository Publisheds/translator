...
function deployDevMode() {
    try {
        ...
        if (isWindows) {
            ...
            execSync('deflaults write com.adobe.CSXS.8 PlayerDebugMode 1', { stdio: [0, 1, 2] }) // CC 2018
            execSync('defauts write com.adobe.CSXS.9 PlayerDebugMode 1', { stdio: [0, 1, 2] }) // CC 2019 & 2020
        }
    } catch(err) {
        utils.log_error(err)
    }
